...
export default function SharePresentationPage() {
  ...
  return (
    <div className="bg-white flex flex-col items-center relative min-h-screen w-full">
      {/* Header */}
      <div className="flex h-[80px] items-center justify-between px-[32px] py-[6px] w-full">
        <div className="flex gap-[24px] items-end px-[12px] py-[16px]">
          <Link href="/" className="h-[28px] w-[112px] relative">
            <Image
          ...
          <p className="font-['Inter',sans-serif] text-[18px] text-[#0d0d0d] tracking-[-0.36px]">
            {presentation.title}
          </p>
        </div>
        <div className="flex gap-[6px] items-center">
          <Link
            href="/signup"
            className="bg-[#0d0d0d] flex items-center justify-center px-[16px] py-[10px] rounded-[999px] hover:bg-[#2e2e2e] transition-colors"
          >
            <span className="font-['Inter',sans-serif] text-[18px] text-white tracking-[-0.36px]">
              Start for free
            </span>
          </Link>
          <button
      ...
      <div className="flex flex-col items-center justify-center px-[40px] py-[20px] w-full">
        <div className="flex items-start justify-center w-full max-w-[1374px]">
          <div className="border-[0.956px] border-[#0d0d0d] border-solid flex-1 h-[772px] relative rounded-[15.289px] overflow-hidden bg-[#0d0d0d]">
            {imageLoading && (
      ...
      {/* Toolbar */}
      <div className="bg-[#2e2e2e] border-[1.4px] border-[rgba(255,255,255,0.4)] border-solid flex gap-[12px] items-center justify-center p-[12px] rounded-[100px] mb-4">
        {/* Microphone */}
        <button
      ...
      <div className="flex flex-col h-[64px] items-center justify-center w-full">
        <div className="flex gap-[4px] items-center justify-center">
          <p className="font-['Inter',sans-serif] text-[12px] text-[#0d0d0d] tracking-[-0.24px]">
            Powered by
          </p>
